            ...
            <div class="card-body">
                ...
                <table class="table table-striped" id="services">
                    ...
                    <tr>
                        ...
                        <td class="py-1">{{$service['MerchantServiceCode']}}</td>
                        <td class="py-1">
                            ...
                            <a href="{{ url('/management/services/edit', $service['MerchantServiceCode']) }}" style="color:white;"><i data-feather="edit"></i></a>
                            </button>

                            <button type="button" class="btn btn-danger btn-icon">
                            <a href="{{ url('/management/services/delete', $service['MerchantServiceCode']) }}" style="color:white;"><i data-feather="delete"></i></a>
                            </button> 
...
@push('custom-scripts')
  ...
  <script src="{{ asset('assets/js/sweet-alert.js') }}"></script>
    ...
    <script>
                    ...
                    $('#services').on( 'page.dt', function () {
                        setTimeout(function(){
                            $('.livicon').updateLivicon();
                        },500);
                    } );
                    $('#services').on( 'length.dt', function ( e, settings, len ) {
                        setTimeout(function(){
                            $('.livicon').updateLivicon();
                        },500);
                    } );
