                ...
                <table class="table table-striped" id="events-table">
                    ...
                    <tr>
                        ...
                        <td class="py-1">
                            ...
                            <a href="{{ url('/users/role/view', $role->id) }}" style="color:white;"><i data-feather="eye"></i></a>
                            </button> 


                            <button type="button" class="btn btn-primary btn-icon">
                            <a href="{{ url('/users/role/edit', $role->id) }}" style="color:white;"><i data-feather="edit"></i></a>
                            </button> 

                            <button type="button" class="btn btn-danger btn-icon">
                            <a href="{{ url('/reservation/delete', $role->id) }}" style="color:white;"><i data-feather="delete"></i></a>
                            </button> 
