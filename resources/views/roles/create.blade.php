    ...
    <div class="card">
      <div class="card-body">
        <h6 class="card-title">Create Room</h6>
            ...
            <form class="forms-sample" action="{{url('/users/role/store')}}" method="post" id="form-login" autocomplete="off">
            ...
            <div class="row">
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <input name="name" required  type="text" class="form-control" placeholder="Enter Role Name">
                </div>
              </div><!-- Col -->
              <div class="col-sm-4">
