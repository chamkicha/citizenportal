            ...
            <div class="card-body">
                ...
                <table class="table table-striped" id="events-table">
                    ...
                    <tr>
                        ...
                        <td class="py-1">{{ $categorie->category_name }}</td>
                        <td class="py-1">

                            <button type="button" class="btn btn-success btn-icon">
                            <a href="{{ url('/categories/view', $categorie->id) }}" style="color:white;"><i data-feather="eye"></i></a>
                            </button> 


                            <button type="button" class="btn btn-primary btn-icon">
                            <a href="{{ url('/categories/edit', $categorie->id) }}" style="color:white;"><i data-feather="edit"></i></a>
                            </button> 

                            <button type="button" class="btn btn-danger btn-icon">
                            <a href="{{ url('/categories/delete', $categorie->id) }}" style="color:white;"><i data-feather="delete"></i></a>
                            </button> 
