<nav class="sidebar">
  ...
  <div class="sidebar-body">
    <ul class="nav">
      ...
      <li class="nav-item {{ active_class(['merchant/*']) }}">
        ...
        <div class="collapse {{ show_class(['merchant/*']) }}" id="email">
          <ul class="nav sub-menu">
            <li class="nav-item">
              <a href="{{ route('merchant') }}" class="nav-link {{ active_class(['merchant/merchant']) }}">Merchants</a>
            </li>
            <li class="nav-item">
      ...
      <li class="nav-item {{ active_class(['users/*']) }}">
        <a class="nav-link" data-toggle="collapse" href="#users" role="button" aria-expanded="{{ is_active_route(['users/*']) }}" aria-controls="email">
