    ...
    <div class="card">
      <div class="card-body">
        <h6 class="card-title">Create Service</h6>
            ...
            <form class="forms-sample" action="{{url('/users/users/update',$users->id)}}" method="post" id="form-login" autocomplete="off">
            ...
            <div class="row">
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <input type="text"    value="{{ $users->full_name }}"  class="form-control" name="full_name" placeholder="FullName">
            ...
            <div class="row">
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <input type="text" value="{{ $users->phone_no }}" class="form-control"  name="phone_no" placeholder="PhoneNumber">
