  ...
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <div>
            <h4 class="mb-3 mb-md-0">User Details</h4>
        </div>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="py-1">{{$users->full_name}}</td>
                        </tr>
                        
                        <tr>
                            <td class="py-1">Phone No:</td>
                            <td class="py-1">{{$users->phone_no  }}</td>
                        </tr>
                        
                        <tr>
                            <td class="py-1">Email:</td>
                            <td class="py-1">{{$users->email }}</td>
                        </tr>
                        
                        <tr>
                            <td class="py-1">Created At:</td>
                            <td class="py-1">{!! \Carbon\Carbon::parse($users->created_at)->format('d-M-y') !!}</td>
                        </tr>
                    </tbody>
                </table>
                </div>
