                ...
                <table class="table table-striped" id="events-table">
                    ...
                    <tr>
                        ...
                        <td class="py-1">
                            ...
                            <?php
                            $categories = DB::table('categories')->where('id', $product->categories_id)->first();
                        ...
                        <td class="py-1">
                            ...
                            <a href="{{ url('/products/view', $product->id) }}" style="color:white;"><i data-feather="eye"></i></a>
                            </button> 


                            <button type="button" class="btn btn-primary btn-icon">
                            <a href="{{ url('/products/edit', $product->id) }}" style="color:white;"><i data-feather="edit"></i></a>
                            </button> 

                            <button type="button" class="btn btn-danger btn-icon">
                            <a href="{{ url('/products/delete', $product->id) }}" style="color:white;"><i data-feather="delete"></i></a>
                            </button> 
